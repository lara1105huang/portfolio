 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d0=Gi.ServerValue;function f0(n){n.INTERNAL.registerComponent(new Ns("database-compat",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app-compat").getImmediate(),i=e.getProvider("database").getImmediate({identifier:t});return new Gi(i,s)},"PUBLIC").setServiceProps({Reference:He,Query:be,Database:Gi,DataSnapshot:$t,enableLogging:Yb,INTERNAL:h0,ServerValue:d0}).setMultipleInstances(!0)),n.registerVersion(s0,i0)}f0(ls);const g0={apiKey:"AIzaSyBBST3cgbXT_FwRbfjs16O8Q8GuMEyJqrU",authDomain:"noodle-616c7.firebaseapp.com",databaseURL:"https://noodle-616c7-default-rtdb.firebaseio.com",projectId:"noodle-616c7",storageBucket:"noodle-616c7.appspot.com",messagingSenderId:"329518419635",appId:"1:329518419635:web:ea2e879e3cd434a16baac6"};ls.initializeApp(g0);ls.apps.length||ls.initializeApp(firebaseConfig);Xy();export{ls as f};
